...
* edited install instructions to reference my fork
...
```bash
git clone https://github.com/liveyourheart/dotfiles.git && cd dotfiles && source bootstrap.sh
```
